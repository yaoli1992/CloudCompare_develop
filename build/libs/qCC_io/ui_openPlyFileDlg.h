...
public:
    ...
    void setupUi(QDialog *PlyOpenDlg)
    {
        ...
        elementsEdit->setText(QStringLiteral("0"));
        ...
        propertiesEdit->setText(QStringLiteral("0"));
        ...
        textureCountEdit->setText(QStringLiteral("0"));
        ...
        label_12->setText(QStringLiteral("Nx"));
        ...
        label_13->setText(QStringLiteral("Ny"));
        ...
        label_14->setText(QStringLiteral("Nz"));
