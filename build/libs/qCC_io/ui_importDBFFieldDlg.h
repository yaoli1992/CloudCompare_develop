...
public:
    ...
    {
        ImportDBFFieldDlg->setWindowTitle(QApplication::translate("ImportDBFFieldDlg", "Choose altitude field", 0));
        label->setText(QApplication::translate("ImportDBFFieldDlg", "Do you wish to use one of the DBF field as altitude?", 0));
        label_2->setText(QApplication::translate("ImportDBFFieldDlg", "Values scaling", 0));
        okPushButton->setText(QApplication::translate("ImportDBFFieldDlg", "OK", 0));
        ignorePushButton->setText(QApplication::translate("ImportDBFFieldDlg", "Ignore", 0));
    } // retranslateUi
