...
public:
    ...
    void setupUi(QDialog *DisplayOptionsDlg)
    {
        ...
        ambientColorButton->setText(QStringLiteral("..."));
        ...
        specularColorButton->setText(QStringLiteral("..."));
        ...
        diffuseColorButton->setText(QStringLiteral("..."));
        ...
        meshFrontColorButton->setText(QStringLiteral("..."));
        ...
        meshBackColorButton->setText(QStringLiteral("..."));
        ...
        meshSpecularColorButton->setText(QStringLiteral("..."));
        ...
        pointsColorButton->setText(QStringLiteral("..."));
        ...
        bkgColorButton->setText(QStringLiteral("..."));
        ...
        bbColorButton->setText(QStringLiteral("..."));
        ...
        textColorButton->setText(QStringLiteral("..."));
        ...
        labelOpacitySpinBox->setSuffix(QStringLiteral("%"));
        ...
        labelBkgColorButton->setText(QStringLiteral("..."));
        ...
        labelMarkerColorButton->setText(QStringLiteral("..."));
        ...
        maxCloudSizeDoubleSpinBox->setPrefix(QStringLiteral("> "));
        maxCloudSizeDoubleSpinBox->setSuffix(QStringLiteral(" M."));
        ...
        maxMeshSizeDoubleSpinBox->setPrefix(QStringLiteral("> "));
        maxMeshSizeDoubleSpinBox->setSuffix(QStringLiteral(" M."));
    ...
    void retranslateUi(QDialog *DisplayOptionsDlg)
    {
        ...
        drawRoundedPointsCheckBox->setText(QApplication::translate("DisplayOptionsDlg", "Draw rounded points (slower)", 0));
        ...
        autoDisplayNormalsCheckBox->setText(QApplication::translate("DisplayOptionsDlg", "Automatically display normals at loading time (when available)", 0));
        useNativeDialogsCheckBox->setText(QApplication::translate("DisplayOptionsDlg", "Use native load / save dialogs", 0));
